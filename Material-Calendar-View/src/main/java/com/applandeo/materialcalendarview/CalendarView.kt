...
class CalendarView @JvmOverloads constructor(
    ...
    private fun initCalendarProperties(typedArray: TypedArray) = with(calendarProperties) {
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
            ...
            headerTypeface = typedArray.getFont(R.styleable.CalendarView_typeface)
    ...
    private fun initAttributes() {
        with(calendarProperties) {
            ...
            rootView.setHeaderTypeface(headerTypeface)
    ...
    fun setTodayTypeface(typeface: Typeface) {
        with(calendarProperties) {
            todayTypeface = typeface
        }
    }
